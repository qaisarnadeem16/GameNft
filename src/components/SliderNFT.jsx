...
function SampleNextArrow(props) {
    const { onClick } = props;
    return (
        <div className=' text-[rgba(0,255,255,0.89)] text-[3rem] z-10 absolute left-[-15px] md:top-[49%] top-[43%] '
...
function SamplePrevArrow(props) {
    const { onClick } = props;
    return (
        <div className=' text-[rgba(0,255,255,0.89)] text-[3rem] z-10 absolute right-[-15px]  md:top-[49%] top-[43%] '
