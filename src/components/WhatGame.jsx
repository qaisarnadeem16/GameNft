                ...
                <div className="flex flex-col md:flex-row items-stretch flex-wrap   ">
                    ...
                    <motion.div
                        ...
                        <div className="main-div main-div2 !mt-7 shadow">
                            <h2 className="text-[rgba(0,255,255,0.91)] text-2xl font-bold tracking-widest text-center p-2 ">HOW DOES <br /> GAME WORK:</h2>
                    ...
                    <motion.div
                        ...
                        <div className="main-div main-div2 !mt-7 shadow2">
                            <h2 className="text-[rgba(0,255,255,0.91)] text-2xl font-bold tracking-widest text-center p-2 ">SINGLE PLAYER: </h2>
                            <p className="p-3 text-white">
                    ...
                    <motion.div
                        ...
                        transition={{ ...transition, type: 'tween' }} style={{ position: 'relative' }}  className="md:w-1/3 w-full md:p-5 p-3">
                        <div className="main-div main-div2 !mt-7 shadow">
                            <h2 className="text-[rgba(0,255,255,0.91)] text-2xl font-bold tracking-widest text-center p-2 "> MULTI PLAYER (1V4): </h2>
                            <p className="p-3 text-white">
                    ...
                    <motion.div
                        ...
                        <div className="main-div main-div2 !mt-7 shadow2">
                            <h2 className="text-[rgba(0,255,255,0.91)] text-2xl font-bold tracking-widest text-center p-2 "> RULES OF GAMEPLAY: </h2>
                            <p className="p-3 text-white ">
